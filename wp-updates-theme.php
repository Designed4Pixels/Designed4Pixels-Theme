...
new WPUpdatesThemeUpdater_1738( 'http://wp-updates.com/api/2/theme', basename(get_template_directory()) );
*/

if( !class_exists('WPUpdatesThemeUpdater_1947') ) {
    class WPUpdatesThemeUpdater_1947 {
