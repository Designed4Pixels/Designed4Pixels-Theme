...
foreach ( $widget_settings as $number => $value ) {
	...
	if ( is_array($widget_settings[ $number ])) {
		...
		$wp_customize->add_setting( 'd4p_image_feature_heading_font_' . $number,
			array(
		...
		$wp_customize->add_control( new WP_Customize_Font_Control( $wp_customize, 'd4p_image_feature_heading_font_' . $number,
    		array(
        		'type' => 'select_font',
        		'select_class' => 'customize-heading-font',
        		'show_styles'	=> false,
        		'label' => __('Image Feature Heading Font ('. $version . ')', 'designed4pixels' ),
		...
		$wp_customize->add_setting( 'd4p_image_feature_body_font_' . $number,
			array(
				'default' => 'Source Sans Pro',
    			'transport'   => 'postMessage',
		));
		...
		$wp_customize->add_control( new WP_Customize_Font_Control( $wp_customize, 'd4p_image_feature_body_font_' . $number,
    		array(
        		'type' => 'select_font',
        		'select_class' => 'customize-body-font',
        		'show_styles'	=> false,
        		'label' => __('Image Feature Body Font ('. $version . ')', 'designed4pixels' ),
        		'section' => 'd4p_image_feature_colors_' . $number,
        		'choices' => d4p_google_font_options(),
        )));
