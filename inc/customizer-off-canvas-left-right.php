...
*/
    	...
    	$wp_customize->add_section( 'd4p_off_canvas_colors', 
			array(
				'title' => __( 'Off Canvas Colors (Left/Right)', 'designed4pixels' ),
				'description' => __( 'Customize Your Websites Off Canvas;', 'designed4pixels' ),
				'priority' => 60,
				'panel' => 'd4p_color_settings',
				'active_callback' => 'off_canvas_active',
		));
		...
		$wp_customize->add_setting(
			'd4p_off_canvas_background_color',
			array(
				'default'     => $color_settings[ 'd4p_off_canvas_background_color' ],
				'type'        => 'theme_mod',
		...
		$wp_customize->add_control( new Customize_Alpha_Color_Control( $wp_customize,
				...
				array(
					...
					'section'       => 'd4p_off_canvas_colors',
					'settings'      => 'd4p_off_canvas_background_color',
		...
		// Alpha Color Picker setting.
		$wp_customize->add_setting(
			'd4p_off_canvas_widget_background_color',
			array(
				'default'     => $color_settings[ 'd4p_off_canvas_widget_background_color' ],
				'type'        => 'theme_mod',
				'capability'  => 'edit_theme_options',
				'transport'   => 'postMessage'
			)
		...
		$wp_customize->add_control( new Customize_Alpha_Color_Control( $wp_customize,
				...
				array(
					...
					'section'       => 'd4p_off_canvas_colors',
					'settings'      => 'd4p_off_canvas_widget_background_color',
					'show_opacity'  => true, // Optional.
					'palette'	=> array(
						'rgba( 0, 0, 0, 0.2 )',			// Black
						'rgba( 255, 255, 255, 0.8 )',	// White
		...
		$wp_customize->add_setting( 'd4p_off_canvas_font_color',
			array(
				'default' => $color_settings[ 'd4p_off_canvas_font_color' ],
    			'transport'   => 'postMessage',
    			'sanitize_callback' => 'd4p_sanitize_hex_color',
		));

		$wp_customize->add_control( new WP_Customize_Color_Control( $wp_customize, 'd4p_off_canvas_font_color',
			array(
		...
		$wp_customize->add_setting( 'd4p_off_canvas_header_color',
			array(
				'default' => $color_settings[ 'd4p_off_canvas_header_color' ],
    			'transport'   => 'postMessage',
    			'sanitize_callback' => 'd4p_sanitize_hex_color',
		));

		$wp_customize->add_control( new WP_Customize_Color_Control( $wp_customize, 'd4p_off_canvas_header_color',
			array(
		...
		$wp_customize->add_setting( 'd4p_off_canvas_border_color',
			array(
				'default' => $color_settings[ 'd4p_off_canvas_border_color' ],
    			'transport'   => 'postMessage',
    			'sanitize_callback' => 'd4p_sanitize_hex_color',
		));

		$wp_customize->add_control( new WP_Customize_Color_Control( $wp_customize, 'd4p_off_canvas_border_color',
			array(
