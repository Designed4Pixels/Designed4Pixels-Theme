...
/* Home Page Slider Feature Settings */


$d4p_slider_feature_widget_settings = (array) get_theme_mod( 'd4p_slider_feature_widget_settings');

$d4p_slider_feature_color_settings = (array) get_theme_mod( 'd4p_slider_feature_color_settings');
...
if ( is_array( $d4p_active_widgets)) {
	...
	foreach ( $d4p_slider_feature_widget_settings as $widget_number => $value ) {

		if ( in_array($d4p_slider_feature_widget_settings[ $widget_number ]['id'], $d4p_active_widgets)) {
	...
	set_theme_mod( 'd4p_slider_feature_color_settings', $d4p_slider_feature_color_settings );

}


function d4p_slider_feature_settings( $d4p_color_default_settings ) {

	$d4p_slider_feature_color_settings = (array) get_theme_mod( 'd4p_slider_feature_color_settings');

	if ( is_array( $d4p_slider_feature_color_settings ) ) {

		return ( array_merge( $d4p_color_default_settings, $d4p_slider_feature_color_settings ));
	...
	add_filter( 'd4p_color_default_settings', 'd4p_slider_feature_settings', 10, 1 );
