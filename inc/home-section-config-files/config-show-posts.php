...
$d4p_show_posts_feature_font_settings = (array) get_theme_mod( 'd4p_show_posts_feature_font_settings');
...
if ( is_array( $d4p_active_widgets)) {
	...
	foreach ( $d4p_show_posts_feature_widget_settings as $widget_number => $value ) {
		...
		if ( in_array($d4p_show_posts_feature_widget_settings[ $widget_number ]['id'], $d4p_active_widgets)) {
			...
			$d4p_show_posts_feature_font_settings[ 'd4p_show_posts_heading_font_' . $widget_number ] 					= 'Source Sans Pro';
			$d4p_show_posts_feature_font_settings[ 'd4p_show_posts_body_font_' . $widget_number ] 						= 'Source Sans Pro';
			...
			unset( $d4p_show_posts_feature_font_settings[ 'd4p_show_posts_heading_font_' . $widget_number ] );
			unset( $d4p_show_posts_feature_font_settings[ 'd4p_show_posts_body_font_' . $widget_number ] );
	...
	set_theme_mod( 'd4p_show_posts_feature_font_settings', $d4p_show_posts_feature_font_settings );
...
function d4p_show_posts_feature_font_settings( $d4p_default_settings ) {

	$d4p_show_posts_font_settings = (array) get_theme_mod( 'd4p_show_posts_feature_font_settings');

	if ( is_array( $d4p_show_posts_font_settings ) ) {

		return ( array_merge( $d4p_default_settings, $d4p_show_posts_font_settings ));
...
add_filter( 'd4p_default_settings', 'd4p_show_posts_feature_font_settings', 10, 1 );
