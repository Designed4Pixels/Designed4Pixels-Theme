...
if ( is_array( $d4p_active_widgets)) {
	...
	foreach ( $d4p_image_feature_widget_settings as $widget_number => $value ) {

		if ( in_array($d4p_image_feature_widget_settings[ $widget_number ]['id'], $d4p_active_widgets)) {

			$d4p_image_feature_color_settings['d4p_image_feature_background_' . $widget_number]				= '#fefefe';
			$d4p_image_feature_color_settings['d4p_image_feature_text_color_' . $widget_number]				= '#999';
			$d4p_image_feature_color_settings['d4p_image_feature_header_color_' . $widget_number] 			= '#666';
			...
			unset( $d4p_image_feature_widget_settings[ $widget_number ] );
			unset( $d4p_image_feature_color_settings['d4p_image_feature_background_' . $widget_number] );
			unset( $d4p_image_feature_color_settings['d4p_image_feature_text_color_' . $widget_number] );
			unset( $d4p_image_feature_color_settings['d4p_image_feature_header_color_' . $widget_number] );
...
function d4p_hero_image_color_settings( $d4p_color_default_settings ) {
	...
	if ( is_array( $d4p_image_feature_color_settings ) ) {

		return ( array_merge( $d4p_color_default_settings, $d4p_image_feature_color_settings ));
