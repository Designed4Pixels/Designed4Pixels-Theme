...
/* Home Page Image Feature Settings */
		...
		if ( is_array( $d4p_active_widgets)) {
			...
			foreach ( $d4p_parallax_feature_widget_settings as $widget_number => $value ) {

				if ( in_array($d4p_parallax_feature_widget_settings[ $widget_number ]['id'], $d4p_active_widgets)) {

					unset( $d4p_parallax_feature_color_settings[ 0 ] );
					$d4p_parallax_feature_color_settings['d4p_parallax_header_color_' . $widget_number]					= '#444';
					$d4p_parallax_feature_color_settings['d4p_parallax_font_color_' . $widget_number]					= '#777';
					$d4p_parallax_feature_color_settings['d4p_parallax_border_color_' . $widget_number]		  			= '#f1f1f1';
					$d4p_parallax_feature_color_settings['d4p_parallax_hr_color_' . $widget_number] 					= '#777';
					$d4p_parallax_feature_color_settings['d4p_parallax_feature_mask_color_' . $widget_number] 			= 'rgba(255, 255, 255, 0.7)';
					...
					unset( $d4p_parallax_feature_color_settings['d4p_parallax_header_color_' . $widget_number] );
					unset( $d4p_parallax_feature_color_settings['d4p_parallax_font_color_' . $widget_number] );
					unset( $d4p_parallax_feature_color_settings['d4p_parallax_border_color_' . $widget_number] );
					unset( $d4p_parallax_feature_color_settings['d4p_parallax_hr_color_' . $widget_number] );
					unset( $d4p_parallax_feature_color_settings['d4p_parallax_feature_mask_color_' . $widget_number] );
...
function d4p_parallax_feature_settings( $d4p_color_default_settings ) {

	$d4p_parallax_feature_color_settings = (array) get_theme_mod( 'd4p_parallax_feature_color_settings');

	if ( is_array( $d4p_parallax_feature_color_settings ) ) {

		return ( array_merge( $d4p_color_default_settings, $d4p_parallax_feature_color_settings ));
