...
foreach ( $widget_settings as $number => $value ) {
	...
	if ( is_array($widget_settings[ $number ])) {
		...
		$wp_customize->add_section( 'd4p_slider_feature_colors_' . $number, 
			array(
				'title' => __( 'Show Slider Feature Colors ('. $version . ')', 'designed4pixels' ),
				'description' => __( 'Customize Your Websites Slider Feature;', 'designed4pixels' ),
				'priority' => 60,
		...
		$wp_customize->add_setting( 'd4p_slider_feature_bottom_border_color_' . $number,
			array(
				'default'     => $color_settings[ 'd4p_slider_feature_bottom_border_color_' . $number ],
				'type'        => 'theme_mod',
		...
		$wp_customize->add_control( new Customize_Alpha_Color_Control( $wp_customize,
				'd4p_slider_feature_bottom_border_color_' . $number,
				array(
					'label'         => __( 'Show Posts Bottom Border Color ('. $version . ')', 'designed4pixels' ),
					'section'       => 'd4p_slider_feature_colors_' . $number,
					'settings'      => 'd4p_slider_feature_bottom_border_color_' . $number,
